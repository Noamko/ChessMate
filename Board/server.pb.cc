...
const uint32_t TableStruct_server_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::server::HelloRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::server::HelloRequest, _impl_.name_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::server::HelloResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::server::HelloResponse, _impl_.message_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::server::HelloRequest)},
  { 7, -1, -1, sizeof(::server::HelloResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::server::_HelloRequest_default_instance_._instance,
  &::server::_HelloResponse_default_instance_._instance,
};
...
const ::_pbi::DescriptorTable descriptor_table_server_2eproto = {
    false, false, 167, descriptor_table_protodef_server_2eproto,
    "server.proto",
...
HelloRequest::HelloRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:server.HelloRequest)
}
HelloRequest::HelloRequest(const HelloRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:server.HelloRequest)
}
...
HelloRequest::~HelloRequest() {
  // @@protoc_insertion_point(destructor:server.HelloRequest)
...
// @@protoc_insertion_point(message_clear_start:server.HelloRequest)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "server.HelloRequest.name"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* HelloRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:server.HelloRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:server.HelloRequest)
  return target;
}

size_t HelloRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:server.HelloRequest)
  size_t total_size = 0;
...
void HelloRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:server.HelloRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:server.HelloRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
HelloResponse::HelloResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:server.HelloResponse)
}
HelloResponse::HelloResponse(const HelloResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:server.HelloResponse)
}
...
HelloResponse::~HelloResponse() {
  // @@protoc_insertion_point(destructor:server.HelloResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:server.HelloResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "server.HelloResponse.message"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* HelloResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:server.HelloResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:server.HelloResponse)
  return target;
}

size_t HelloResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:server.HelloResponse)
  size_t total_size = 0;
...
void HelloResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:server.HelloResponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:server.HelloResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::server::HelloRequest*
Arena::CreateMaybeMessage< ::server::HelloRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::server::HelloRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::server::HelloResponse*
Arena::CreateMaybeMessage< ::server::HelloResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::server::HelloResponse >(arena);
}
